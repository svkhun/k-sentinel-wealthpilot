...
## 🏛️ 5. สถาปัตยกรรมระบบ (Two-Tier Low-Latency Architecture)
...
graph TD
    ...
    subgraph "Tier 3: Client Experience & Web SPAs"
        API --> ReactRouter["⚛️ React 18 + React Router 6 SPA (Port 5173)"]
...
│   ├── react-app/                     # ⚛️ React 18 + React Router 6 Modular App
